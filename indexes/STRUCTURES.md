...
| ST-0004 | Attack/spell record — 14 bytes at `ROMCPU:$C46AC0`+14×index (`ROMFILE:0x046AC0`) | Documented; implemented (`attackdata.Record`, synthetic-fixture tests + fuzz) | **Confirmed** (loader byte-exact; field semantics per pipeline decodes: +1 element, +2 flags, +3 MP-target, +4 mode, +6 power, +10 abort bits; 7 bytes Unknown) | [EXP-0019](../docs/experiments/EXP-0019-rng-state.md) |
