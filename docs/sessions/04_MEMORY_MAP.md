...
| `WRAM:+$11B0` | 2 | **Confirmed** (code role) | Precomputed base amount consumed by variant A and boosted in place by `$C20D4A`. Producer unknown — question #23 (battle-power/level layer). |
